...
#actions = np.array(['ExcuseMe','Who are you','clear','Good Morning','How you know','I','want','water','Pen','Call me','You'])
#10 videos worth of data
#actions = np.array(['pen','clear','You','water','book','need','help','I'])
